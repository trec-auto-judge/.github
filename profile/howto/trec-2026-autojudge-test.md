...
*Part of the [TREC AutoJudge HowTo](README.md). The activity pages ([1](01-setup-environment.md)–[8](08-run-on-tira-custom-endpoint.md)) explain each step in depth; this page is the checklist for the 2026 test phase.*
...
## 1. Develop your AutoJudge approach

Build your judge on the [starter kit](https://github.com/trec-auto-judge/auto-judge-starter-kit) — the [HowTo](README.md) walks you through it, from setup to a working judge. Already have one? Continue below.

## 2. Fetch the test data

From your starter-kit checkout: the user is `trec2026`, and the password is the password of the TREC Active Participants page ([setup step 5](01-setup-environment.md#step-5--fetch-the-evaluation-datasets)):
...
## 3. Run your judge and upload the leaderboards
